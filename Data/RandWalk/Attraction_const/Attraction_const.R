# Simuation of individual based model with constant attraction.
...
setwd("~/Desktop/Chemotacticswarming-master/Data/RandWalk/Attraction_const")
working_dir = "~/Desktop/Chemotacticswarming-master/Data/RandWalk/Attraction_const"
...
dist_file = data.frame(distance = as.vector(t(sqrt((X.mat[,,1])^2+(X.mat[,,2])^2))),time = rep(0:(time_m-1),each=N))
